class RomanNumber:
    ...
    def __add__(self, other):
        ...
        returns result
        '''
        ans = self.int_value + other.int_value
        if 0 < ans < 4000 and type(ans) == int:
            result =  self.roman_number(ans)
    ...
    def __truediv__(self, other):
        ...
        '''
        ans = self.int_value / other.int_value
        if 0 < ans < 4000 and str(ans)[-1] == '0' and str(ans)[-2] == '.':
            result = self.roman_number(ans)
            return RomanNumber(result)
        else:
            return RomanNumber(-1)
    ...
    def __floordiv__(self, other):
        '''
        divides two numbers without remainder
    ...
    def __pow__(self, power):
        '''
        raise to a power two numbers

        returns result
        '''
        ans = self.int_value ** power.int_value
        if 0 < ans < 4000 and type(ans) == int:
            result = self.roman_number(ans)
            return RomanNumber(result)
        else:
    ...
    def roman_number(self, new_num=None):
        '''
        turns arabic number into roman
        args:
            new_num: makes it possible to work with new numbers
